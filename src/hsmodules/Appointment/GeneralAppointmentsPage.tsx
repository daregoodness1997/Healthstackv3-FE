/**
 * General Appointments Page Wrapper
 * Shows all appointments across all location types
 */
...
const GeneralAppointmentsPage: React.FC = () => {
...
export default GeneralAppointmentsPage;
