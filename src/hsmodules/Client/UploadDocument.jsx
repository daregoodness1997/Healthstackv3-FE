...
export default function UploadDocument({ closeModal }) {
  ...
  function handleUploadFile() {
    ...
    uploadFile(
      ...
      .then(async (res) => {
        ...
        const updateClient = { ...Client, archiveurl: res.data.url };
        // console.log(updateClient, "upppppppppppp");
        if (docType === 'Archive') {
          ClientServ.patch(Client._id, updateClient)
            .then((res) => {
              // console.log(res, "neww");
              hideActionLoader();
              closeModal();
