...
export function ReferralList({ client_id, showDetail, showCreate, setSelectedReferral }) {
  ...
  const getReferralList = async () => {
    ...
    console.log(state.employeeLocation.locationId)
    setLoading(true);
   
      let query = {
       "dest_org_location._id": state.employeeLocation.locationId,
       dest_org_acceptance:"Pending",
        $limit: 100,
        $sort: {
          createdAt: -1,
        },
