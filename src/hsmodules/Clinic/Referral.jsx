...
import { ReferralCreate } from "./referral/CreateReferral";

import { NewReferralDetails } from "./referral/ReferralDetails";
...
export default function Referral({client}) {
  ...
  return (
    <Box>
     <ModalBox
        open={view === "detail"}
        onClose={() => setView("list")}//setReferralModal(false)}
        header="Referral"
        width= "80rem"
      >
         <NewReferralDetails
        ...
        />
       {/*  <Referral  client={client._id} closeModal={() => setReferralModal(false)} /> */}
      </ModalBox>
