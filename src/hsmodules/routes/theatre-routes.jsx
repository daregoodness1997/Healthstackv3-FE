...
const TheatreRequest = lazy(() => import('../Theatre/TheatreRequest'))
const TheatreList = lazy(() => import('../Theatre/TheatreList'))
...
export const theatreRoutes = [
   ...
   /*  {
    ...
    {
        path: '/app/theatre/theatre-request',
        Component: TheatreRequest,
    },
    {
        path: '/app/theatre/theatre-list',
