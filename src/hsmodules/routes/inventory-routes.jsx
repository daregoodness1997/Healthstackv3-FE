...
//import InventryTranferr from "../inventory/InventryTranferr";
...
const InwardTransfer = lazy(() => import('../inventory/InwardTransfer'));
const InventoryRequisition = lazy(
  () => import('../inventory/InventoryRequisition'),
);
const RequisitionAuth = lazy(
  () => import('../inventory/RequisitionAuth'),
);
...
export const inventoryRoutes = [
  ...
  {
    path: '/app/inventory/authorizations',
    Component: RequisitionAuth,
  },
    {
    path: '/app/inventory/requisition',
    Component: InventoryRequisition,
  },
   {
    path: '/app/inventory/inward-transfer',
