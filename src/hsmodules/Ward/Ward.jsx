    ...
    <section className="section remPadTop">
      ...
      <div className="columns ">
        ...
        <div className="column is-4 ">
          ...
          {state.FrontDesk.show === "modify" && (
            <WardModify Clinic={selectedClinic} />
          )}
        </div>
      </div>
    </section>
    ...
    <>
      <div className="card ">
        <div className="card-header">
          <p className="card-header-title">Create Front Desk</p>
        </div>
            ...
            <div className="field">
              <p className="control has-icons-left has-icons-right">
                <input
                  ...
                  name="name"
                  type="text"
                  placeholder="Name of Front Desk"
                />
                <span className="icon is-small is-left">
...
export function WardDetail() {
  ...
  return (
    <>
      <div className="card ">
        <div className="card-header">
          <p className="card-header-title">Front Desk Details</p>
        </div>
        <div className="card-content vscrollable">
          <table>
            <tbody>
    ...
    if (conf) {
      ClinicServ.remove(dleteId)
        ...
        .catch(err => {
          ...
          toast({
            message:
              "Error deleting Front Desk, probable network issues or " + err,
            type: "is-danger",
            dismissible: true,
            pauseOnHover: true,
          });
  ...
  const onSubmit = (data, e) => {
    ...
    ClinicServ.patch(Clinic._id, data)
      ...
      .catch(err => {
        ...
        toast({
          message:
            "Error updating Front Desk, probable network issues or " + err,
          type: "is-danger",
          dismissible: true,
          pauseOnHover: true,
        });
