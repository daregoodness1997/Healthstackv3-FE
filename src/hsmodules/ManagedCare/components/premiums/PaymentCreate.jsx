                ...
                <table className="table is-striped  is-hoverable is-fullwidth is-scrollable ">
                  <thead>
                    <tr>
                      ...
                      <th>
                        <abbr title="Service Detail">Service Detail</abbr>
                      </th>
                      <th>
                        <abbr title="Code">Authorization Code</abbr>
                      </th>
                      <th>
                        <abbr title="Co-pay">Copay Amount</abbr>
                      </th>
                    </tr>
                  </thead>
                  <tfoot></tfoot>
                  <tbody>
                    {productItem.map((ProductEntry, i) => (
                      <tr key={i}>
                        ...
                        <td>
                          {" "}
                          {ProductEntry.serviceInfo.billingContract.map(
                            (contract, i) => (
                              <span key={i} className="ml-1">
                                {contract.plans.map((plan, p) => (
                                  <>
                                    <span className="ml-1">
                                      {" "}
                                      <b>HMO:</b> {contract.source_org_name}
                                    </span>
                                    <span className="ml-1">
                                      {" "}
                                      <b>Plan:</b> {plan.name}
                                    ...
                                    <span className="ml-1">
                                      <b> Require Code:</b>{" "}
                                      {plan.reqAuthCode.toString()}{" "}
                                    </span>
                                    <span className="ml-1">
                                      <b> Copay:</b>
                                      {plan.copay ? plan.copay : "None"}
                                    </span>{" "}
                                    <br></br>
                                  </>
                                ))}
