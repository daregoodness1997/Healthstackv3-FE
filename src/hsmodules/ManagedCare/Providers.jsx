...
import { PreAuthorizationList } from "./PreAuth";
...
const Textarea = lazy(() => import("../../components/inputs/basic/Textarea"));

// Feature components
const SendLinkViaEmail = lazy(() => import("../CRM/components/deals/SendLink"));
const CustomConfirmationDialog = lazy(
  () => import("../../components/confirm-dialog/confirm-dialog"),
);
const ProviderChat = lazy(() => import("./components/Provider/ProviderChat"));
  ...
  return (
    <>
      ...
      >
        ...
        {display === 5 && <BeneList standAlone={facility.organizationDetail} />}
        {display === 6 && <Claims />}
