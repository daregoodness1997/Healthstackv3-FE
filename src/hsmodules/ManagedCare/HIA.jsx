...
import { Box, Grid, IconButton, Button as MuiButton } from '@mui/material';
import Input from '../../components/inputs/basic/Input';
import AddCircleOutline from '@mui/icons-material/AddCircleOutline';
import GlobalCustomButton from '../../components/buttons/CustomButton';
import { BottomWrapper, HeadWrapper } from '../app/styles';
...
export function OrganizationList({ showModal, setShowModal }) {
  ...
  const handleRow = async (facility) => {
    const getData = await orgServ.get(facility._id);
    //await setSelectedFacility(facility.organizationDetail);
    const newfacilityModule = {
      selectedFacility: getData,
      show: 'detail',
    };
    await setState((prevstate) => ({
      ...prevstate,
