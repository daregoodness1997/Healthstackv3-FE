...
const Input = lazy(() => import("../../components/inputs/basic/Input/index"));
const CustomSelect = lazy(() => import("../../components/inputs/basic/Select"));
const MuiCustomDatePicker = lazy(
  () => import("../../components/inputs/Date/MuiDatePicker")
);
const ModalBox = lazy(() => import("../../components/modal"));
...
const FormsHeaderText = lazy(() =>
  import("../../components/texts").then((module) => ({
    default: module.FormsHeaderText,
  }))
);
const FilterMenu = lazy(() => import("../../components/utilities/FilterMenu"));
const TableMenu = lazy(() =>
  import("../../ui/styled/global").then((module) => ({
    default: module.TableMenu,
  }))
);
const PageWrapper = lazy(() =>
  import("../../ui/styled/styles").then((module) => ({
    default: module.PageWrapper,
  }))
);
const HeadWrapper = lazy(() =>
  import("../app/styles").then((module) => ({ default: module.HeadWrapper }))
);
const ModalHeader = lazy(
  () => import("../Appointment/ui-components/Heading/modalHeader")
);
const ClientGroup = lazy(() => import("../Client/ClientGroup"));
const createClientSchema2 = lazy(() =>
  import("../Client/schema").then((module) => ({
    default: module.createClientSchema2,
  }))
);
...
// Lazy load components and larger modules
const FacilitySearchComponents = lazy(() =>
  import("../helpers/FacilitySearch").then((module) => ({
    HmoFacilitySearch: module.HmoFacilitySearch,
    OrgFacilitySearch: module.OrgFacilitySearch,
    SponsorSearch: module.SponsorSearch,
  }))
);
...
const OrganizationCreate = lazy(() =>
  import("./Providers").then((module) => ({
    default: module.OrganizationCreate,
  }))
);

const EnrolleSchemas = lazy(() =>
  import("./schema").then((module) => ({
    EnrolleSchema: module.EnrolleSchema,
    EnrolleSchema2: module.EnrolleSchema2,
    EnrolleSchema3: module.EnrolleSchema3,
    EnrolleSchema4: module.EnrolleSchema4,
    EnrolleSchema5: module.EnrolleSchema5,
  }))
);

const ProviderPrintout = lazy(() =>
  import("./components/Printout").then((module) => ({
    default: module.ProviderPrintout,
  }))
);
const ClientSearch = lazy(() =>
  import("../helpers/ClientSearch").then((module) => ({
    default: module.ClientSearch,
  }))
);
