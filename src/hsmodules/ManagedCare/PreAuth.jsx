...
// Lazy load PreAuth components
const PreAuthListComponent = lazy(
  () => import("./components/preauth/PreAuthList")
);
const PreAuthCreateComponent = lazy(
  () => import("./components/preauth/PreAuthCreate")
);
const PreAuthDetailComponent = lazy(
  () => import("./components/preauth/PreAuthDetail")
);
