...
export const PageLeadDetailView = () => {
  ...
  const probabilityScore =
    probabilitydetail && !isNaN(probabilitydetail.probability)
  ...
  return (
    <>
      ...
      <Grid container spacing={1}>
        ...
        <Grid item lg={2} md={3} sm={4} xs={6}>
          <GlobalCustomButton color="error" onClick={() => setScore(true)}>
            Opportunity Score
          </GlobalCustomButton>
        </Grid>
        ...
        <Grid item lg={2} md={3} sm={6}>
                ...
                <Grid item lg={2} md={3} sm={6}>
                  <Input
                    register={register("worth", {required: true})}
...
export const Opportunity = ({ addInfo, closeModal }) => {
  ...
  const questions = [
    ...
    },
    {
      id: 2,
      question:
        "Client have fund to finance Health Insurance Plan for their staff",
      name: "fund",
      options: [
        {
          value: "Yes",
    ...
    },
    {
      id: 3,
      question:
        "There is a statutory or regulatory compliance driving urgency to purchase Health Insurance",
      name: "compliance",
      options: [
        {
          value: "Yes",
    ...
    },
    {
      id: 4,
      question:
        "There is a change in Board or Management or Union which is driving urgency to purchase Health Insurance or thinking towards Health Insurance",
      name: "urgency",
      options: [
        {
          value: "Yes",
    ...
    },
    {
      id: 5,
      question:
        "There is company-wide discontentment with current solution or process",
      name: "discontentment",
      options: [
        {
          value: "Yes",
    ...
    },
    {
      id: 6,
      question:
        "The company Leaders are not comfortable with the workarounds to complement the current solution or process",
      name: "leaders",
      options: [
        {
          value: "Yes",
		...
		}, */
    {
      id: 7,
      question:
        "The Internal stakeholders within the client company have agreed solution or plan criteria with our team and the client stage in their buying journey for Health Insurance is known",
      name: "stage",
      options: [
        {
        ...
        {
          value:
            "Client request further presentation with all internal stakeholders after the initial meeting",
          score: 2,
        },
        {
          value:
            "Client calls for negotiation of contract & Terms of engagement after the presentation",
          score: 3,
        },
      ],
    },
    {
      ...
      options: [
        {
          value:
            " Client confirms and agree to start the scheme within 1-2 months",
          score: 3,
        },
        {
          value:
            "Client confirms and agree to start the scheme within 3-4 months",
          score: 2,
        },
        {
          value:
            "Client confirms and agree to start the scheme greater than 4 months or timeframe is not known or agreed",
          score: 0,
        },
      ],
    },
    {
      id: 9,
      question:
        "We have the buy-in of the technical buyer for Health Insurance in the client company",
    ...
    },
    {
      id: 10,
      question:
        "We have the buy-in of the economic buyer who have the financial decision to buy health insurance in the client company",
      name: "economic-buyer",
      options: [
        {
          value: "Yes",
    ...
    },
    {
      id: 11,
      question:
        'We have at least one person with influence in the client company who is our "internal advocate or Internal champion" in addition to the technical buyer and economic buyer',
      name: "champion",
      options: [
        {
          value: "Yes",
  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex" }}>
        <GlobalCustomButton onClick={updateScore} sx={{ marginRight: "10px" }}>
          Add Information
        </GlobalCustomButton>
