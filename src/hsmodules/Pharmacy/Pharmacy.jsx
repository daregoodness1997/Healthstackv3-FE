    ...
    <section className="section remPadTop">
      ...
      <div className="columns ">
        ...
        <div className="column is-4 ">
          ...
          {state.StoreModule.show === "modify" && (
            <StoreModify Store={selectedStore} />
          )}
        </div>
      </div>
    </section>
    ...
    <>
      <div className="card ">
        <div className="card-header">
          <p className="card-header-title">Create Store</p>
        </div>
...
export function PharmacyList({standalone, closeModal}) {
  ...
  const handleSearch = val => {
    ...
    StoreServ.find({
      ...
      .then(res => {
        ...
        setMessage(" Pharmacy fetched successfully");
        setSuccess(true);
      })
      .catch(err => {
        console.log(err);
        setMessage("Error fetching Pharmacy, probable network issues " + err);
        setError(true);
      });
  };
...
export function PharmacyListStandalone({standalone, closeModal}) {
  // const { register, handleSubmit, watch, errors } = useForm();
...
export function StoreDetail() {
  ...
  return (
    <>
      <div className="card ">
        <div className="card-header">
          <p className="card-header-title">Store Details</p>
        </div>
        <div className="card-content vscrollable">
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <span className="is-size-7 padleft" name="StoreType">
                    {Store.locationType}{" "}
                  </span>
                </td>
              </tr>
