...
export function Haematology() {
  ...
  const fullBloodCountSchemaNow=[

   {"Full Blood Count (FBC)": [
    { 
      name: 'Hemoglobin', 
      units: [
        { unit: 'g/dL', low: 13.5, high: 17.5 },  // Standard for males
        { unit: 'mmol/L', low: 8.4, high: 10.9 }  // Optional mmol/L equivalent
      ]
    },
    { 
      name: 'White Blood Cells', 
      units: [
        { unit: 'x10^9/L', low: 4.0, high: 11.0 }
      ]
    },
    { 
      name: 'Platelets', 
      units: [
        { unit: 'x10^9/L', low: 150, high: 450 }
      ]
    },
    { 
      name: 'Hematocrit', 
      units: [
        { unit: '%', low: 41, high: 50 },  // Males
        { unit: '%', low: 36, high: 44 }   // Females
      ]
    }
  ]},
  ]
...
const testBatteries = {
  ...
  'Basic Metabolic Panel (BMP)': [
    ...
    { 
      name: 'Chloride', 
      units: [
        { unit: 'mmol/L', low: 96, high: 106 }
      ]
    },
    { 
      name: 'Glucose', 
      units: [
        { unit: 'mg/dL', low: 70, high: 99 },  // Fasting glucose in mg/dL
        { unit: 'mmol/L', low: 3.9, high: 5.5 }  // Equivalent in mmol/L
      ]
    },
    { 
    ...
    { 
      name: 'Calcium', 
      units: [
        { unit: 'mg/dL', low: 8.5, high: 10.2 },
        { unit: 'mmol/L', low: 2.1, high: 2.6 }  // Optional mmol/L conversion
      ]
    }
  ],
  'Comprehensive Metabolic Panel (CMP)': [
    { 
      name: 'Albumin', 
      units: [
        { unit: 'g/dL', low: 3.5, high: 5.0 }
      ]
    },
    { 
      name: 'Total Protein', 
      units: [
        { unit: 'g/dL', low: 6.0, high: 8.3 }
      ]
    },
    { 
      name: 'Alkaline Phosphatase (ALP)', 
      units: [
        { unit: 'U/L', low: 44, high: 147 }
      ]
    },
    { 
    ...
    { 
      ...
      units: [
        ...
        { unit: 'µmol/L', low: 1.7, high: 20.5 }  // Conversion to µmol/L
      ]
    }
  ],
  'Lipid Panel': [
    { 
      ...
      units: [
        ...
        { unit: 'mmol/L', low: 0, high: 5.2 }  // Optional mmol/L equivalent
      ]
    },
    { 
      name: 'HDL (High-Density Lipoprotein)', 
      units: [
        { unit: 'mg/dL', low: 40, high: 60 },
        { unit: 'mmol/L', low: 1.0, high: 1.6 }  // mmol/L conversion
      ]
    },
    { 
      name: 'LDL (Low-Density Lipoprotein)', 
      units: [
        { unit: 'mg/dL', low: 0, high: 100 },
        { unit: 'mmol/L', low: 0, high: 2.6 }  // mmol/L conversion
      ]
    },
    { 
      name: 'Triglycerides', 
      units: [
        ...
        { unit: 'mmol/L', low: 0, high: 1.7 }  // Optional mmol/L equivalent
      ]
    }
  ],
  'Thyroid Function Tests (TFT)': [
    { 
      ...
      units: [
        { unit: 'µU/mL', low: 0.4, high: 4.0 }
      ]
    },
    { 
      name: 'Free T4', 
      units: [
        { unit: 'ng/dL', low: 0.8, high: 2.2 }
      ]
    },
    { 
      name: 'Free T3', 
      units: [
        { unit: 'pg/mL', low: 2.0, high: 4.4 }
      ]
    }
  ]
};
