...
export const OrganizationDetails = ({ organization, goBack }) => {
  ...
  return (
    <Box pt={2} height="90vh" overflow="auto">
      {tab === 'list' && (
        <>
          <Box
            sx={{
          ...
          >
            ...
            >
              <GlobalCustomButton onClick={handleShowStats}>
                View Stats
              </GlobalCustomButton>
              <GlobalCustomButton
                color="secondary"
            ...
            <Grid container spacing={2} mb={2}>
              ...
              <Grid item lg={4} md={6} sm={6} xs={12}>
                <CustomSelect
                  ...
                  options={
                    selectedType
                      ? selectedType?.categories?.sort((a, b) =>
                          a.localeCompare(b),
                        )
                      : []
                  }
		...
		/> */}
          ...
          <Box p={2}>
            <FormsHeaderText text="Config Settings" />
            <Grid container spacing={2} mb={2}>
            <Grid item lg={4} md={6} sm={6} xs={12}>
              <SingleCheckbox
                control={control}
                ...
                label="External Link"
                disabled={!edit}
                defaultChecked={currentOrganization.hasExternalLink}
                setValue={(value) => setValue('hasExternalLink', value === true)}
              />
            </Grid>
            <Grid item lg={4} md={6} sm={6} xs={12}>
              <Input
                register={register('externalLinkDetails')}
