...
export const ObstetricsAssessmentPrintOut = forwardRef(
    ({ data, Clinic }, ref) => {
        ...
        return (
            <Box
                sx={{ width: '100%', height: '100%', padding: '2.5%' }}
                ref={ref}
            >
                <PrintOutFixedInformation Clinic={Clinic} />
...
export const PregnancyAssessmentPrintOut = forwardRef(
    ({ data, Clinic }, ref) => {
...
export const SleepMedicineReferralFormPrintOut = forwardRef(
    ({ data, Clinic }, ref) => {
        return (
            <Box
                sx={{ width: '100%', height: '100%', padding: '2.5%' }}
...
export const PediatricSleepStudyReferralFormPrintOut = forwardRef(
    ({ data, Clinic }, ref) => {
        return (
            <Box
                sx={{ width: '100%', height: '100%', padding: '2.5%' }}
...
export const NutritionAndDieteticsRequestFormPrintOut = forwardRef(
    ({ data, Clinic }, ref) => {
        return (
            <Box
                sx={{ width: '100%', height: '100%', padding: '2.5%' }}
...
export const TheatreOrderPrintOut = forwardRef(({ data, Clinic }, ref) => {
    return (
        <Box sx={{ width: '100%', height: '100%', padding: '2.5%' }} ref={ref}>
            <PrintOutFixedInformation Clinic={Clinic} />
...
export const EpworthSleepinessScalePrintOut = forwardRef(
    ({ data, Clinic }, ref) => {
        return (
            <Box
                sx={{ width: '100%', height: '100%', padding: '2.5%' }}
                    ...
                    <Grid container spacing={3}>
                        {[
                            ...
                            },
                            {
                                ...
                                value:
                                    data.sittingAfterLunchWithoutAlcohol || '',
                            },
                            {
...
export const SleepStudyAuthorizationPrintOut = forwardRef(
    ({ data, Clinic }, ref) => {
        return (
            <Box
                sx={{ width: '100%', height: '100%', padding: '2.5%' }}
...
export const PatientInstructionForSleepStudyPrintOut = forwardRef(
    ({ data, Clinic }, ref) => {
        return (
            <Box
                sx={{ width: '100%', height: '100%', padding: '2.5%' }}
...
export const InsuranceDetailsPrintOut = forwardRef(({ data, Clinic }, ref) => {
    return (
        <Box sx={{ width: '100%', height: '100%', padding: '2.5%' }} ref={ref}>
            <PrintOutFixedInformation Clinic={Clinic} />
...
export const PrivacyAndPolicyPrintOut = forwardRef(({ data, Clinic }, ref) => {
    return (
        <Box sx={{ width: '100%', height: '100%', padding: '2.5%' }} ref={ref}>
            <PrintOutFixedInformation Clinic={Clinic} />
...
export const FatigueSeverityScalePrintOut = forwardRef(
    ({ data, Clinic }, ref) => {
        return (
            <Box
                sx={{ width: '100%', height: '100%', padding: '2.5%' }}
...
export const SleepQuestionnairePrintOut = forwardRef(
    ({ data, Clinic }, ref) => {
        return (
            <Box
                sx={{ width: '100%', height: '100%', padding: '2.5%' }}
...
export const SleepQuestionnaireForSpousePrintOut = forwardRef(
    ({ data, Clinic }, ref) => {
        return (
            <Box
                sx={{ width: '100%', height: '100%', padding: '2.5%' }}
...
export const SleepHistoryAndIntakePrintOut = forwardRef(
    ({ data, Clinic }, ref) => {
...
export const WeeklySleepLogPrintOut = forwardRef(({ data, Clinic }, ref) => {
    const StudySchema = [
        {
            name: 'S/N',
            key: 'sn',
...
export const AgonistProtocolPrintOut = forwardRef(({ data, Clinic }, ref) => {
...
export const NursesContinuationSheetPrintOut = forwardRef(
    ({ data, Clinic }, ref) => {
        return (
            <Box
                sx={{ width: '100%', height: '100%', padding: '2.5%' }}
...
export const FemaleHistoryListPrintOut = forwardRef(({ data, Clinic }, ref) => {
    return (
        <Box sx={{ width: '100%', height: '100%', padding: '2.5%' }} ref={ref}>
            <PrintOutFixedInformation Clinic={Clinic} />
...
export const HeamodialysisNursingPrintOut = forwardRef(
    ({ data, Clinic }, ref) => {
...
export const AntagonistProtocolPrintOut = forwardRef(
    ({ data, Clinic }, ref) => {
        const StimulationColumns = [
            {
                name: 'Start Date',
...
export const RecipientTreatmentPrintOut = forwardRef(
    ({ data, Clinic }, ref) => {
        const StimulationColumns = [
            {
                name: 'Start Date',
...
export const LaboratoryResultsPrintOut = forwardRef(({ data, Clinic }, ref) => {
...
export const LaboratoryTreatmentPrintOut = forwardRef(
    ({ data, Clinic }, ref) => {
...
export const TreatmentSummaryPrintOut = forwardRef(({ data, Clinic }, ref) => {
...
export const IntrauterineInseminationPrintOut = forwardRef(
    ({ data, Clinic }, ref) => {
        const StimulationColumns = [
            {
                name: 'Start Date',
