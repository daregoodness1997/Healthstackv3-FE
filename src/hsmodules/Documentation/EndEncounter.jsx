    ...
    <>
      <div className="card ">
        ...
        <div className="card-content vscrollable">
            ...
            <div className="field">
              <p className="control">
                <button className="button is-success is-small" onClick={handleSubmit(onSubmit)}>Create</button>
              </p>
            </div>
...
export function EndEncounterList({standalone, closeModal}) {
  ...
  const handleRow = async item => {
    ...
    // const expr = 'Papayas';
    if(!state.AppointmentModule.selectedAppointment.encounter_ended_at)
    await AppointmentServ.patch(state.AppointmentModule.selectedAppointment._id, {encounter_ended_at: new Date()})
    closeModal();
  };
