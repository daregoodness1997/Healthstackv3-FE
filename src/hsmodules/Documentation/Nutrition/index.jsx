...
import DietaryPrescription from './DietaryPrescription'
import NAndDRequestForm from './NAndDRequestForm'
...
export default function NutritionAndDieteticsRequestForm() {
    ...
    const { handleSubmit, setValue, reset, registerWithBlur, control } =
        ...
        <>
            <div className="card ">
                ...
                >
                    <FormsHeaderText
                        text={
                            state?.DocumentClassModule.selectedDocumentClass
                                .name || ''
                        }
                    />
                ...
                <Box sx={{ width: '100%' }}>
                    ...
                    <>
                        ...
                        <CustomTabPanel value={tabValue} index={3}>
                            <NAndDRequestForm register={registerWithBlur} />
                        </CustomTabPanel>
                    </>
                </Box>
                {tabValue === 3 && (
