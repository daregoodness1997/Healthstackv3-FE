...
export default function PediatricForm() {
  ...
  const onSubmit = (data, e) => {
    ...
    document.documentname = "Pediatric Form"; //"Lab Result"
    ...
    if (!!draftDoc && draftDoc.status === "Draft") {
      ClientServ.patch(draftDoc._id, document)
        .then((res) => {
          ...
          setSuccess(true);
          hideActionLoader();
          toast.success("Pediatric  Form updated succesfully");
          setSuccess(false);
          reset(data);
        ...
        .catch((err) => {
          hideActionLoader();
          toast.error("Error updating Pediatric  Form " + err);
        });
    } else {
    ...
    <>
      <div className="card ">
        <CustomConfirmationDialog
          ...
          type="create"
          message="you're about to save Pediatric  Form?"
        ...
        <Box
          ...
          mb={1}
        >
          <FormsHeaderText text="Pediatric Form" />
          ...
          <>
            ...
            <Box sx={{ gap: "1.5rem" }}>
              ...
              <Box mb={2}>
                ...
                <Textarea
                  text={"text"}
                  register={register("CVS Additional info")}
                />
              </Box>
            </Box>
            ...
            <Box sx={{ display: "flex", flexDirection: "column" }} gap={1.5}>
              ...
              <Box mb={2}>
                ...
                <Textarea
                  text={"text"}
                  register={register("ENT Additional info")}
                />
              </Box>
            </Box>
