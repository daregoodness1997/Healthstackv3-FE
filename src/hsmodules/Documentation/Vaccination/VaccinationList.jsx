...
export default function VaccinationList({ standalone }) {
  ...
  const handleDelete = (doc) => {
    ...
    let confirm = window.confirm(
      `You are about to delete the Vaccination: ${doc.order}?`
    );
    if (confirm) {
      OrderServ.remove(doc._id)
        ...
        .catch((err) => {
          toast({
            message: "Error deleting Vaccination" + err,
            type: "is-danger",
            dismissible: true,
            pauseOnHover: true,
          });
