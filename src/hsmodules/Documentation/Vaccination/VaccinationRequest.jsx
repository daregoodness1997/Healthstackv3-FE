...
export default function VaccinationCreate() {
  ...
  }, [state.ClientModule.selectedClient, source]);
  ...
  const handleSubmitVaccination = async () => {
    ...
    try {
      ...
      toast.error(`Error creating Vaccination: ${err}`);
    } finally {
      hideActionLoader();
    }
  };
  ...
  return (
    <Box>
      ...
      >
        <FormsHeaderText text="Create Vaccination Request" />
      ...
      {productItems.length > 0 && (
        <>
          ...
          <Box sx={{ display: "flex", justifyContent: "flex-end" }}>
            <GlobalCustomButton onClick={handleSubmitVaccination}>
              Complete
            </GlobalCustomButton>
          </Box>
        </>
