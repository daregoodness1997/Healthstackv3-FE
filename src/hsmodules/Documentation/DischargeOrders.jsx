...
export default function DischargeOrders() {
 ...
 */
  ...
  const onSubmit = () => {
    ...
    document.documentname = "Discharge Order"; //state.DocumentClassModule.selectedDocumentClass.name
  ...
  useEffect(() => {
    setDestination(user.currentEmployee.facilityDetail.facilityName);
    setDestinationId(user.currentEmployee.facilityDetail._id);
    setWard(state.WardModule.selectedWard);
...
export function DischargeOrdersList({standalone}) {
