...
export default function DoctorNoteCreate() {
    ...
    const onSubmit = async (data) => {
        ...
        try {
          ...
          await closeEncounterRight();
          
        } catch (err) {
          toast.error("Error submitting Doctor Note: " + err);
    ...
    const closeEncounterRight = async () => {
      // Wrap in try-catch to handle potential state update errors
      try {
        ...
        toast.error("Error closing encounter. Please try again.");
      }
    };
      ...
      <>
        <div className="card ">
          ...
          <Box
            ...
            mb={1}
          >
            <FormsHeaderText text={"Doctor Note"} />
