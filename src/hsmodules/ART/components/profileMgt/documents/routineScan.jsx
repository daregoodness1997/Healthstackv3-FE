...
export default function RoutineScanAndExamination() {
  ...
  const onSubmit = async (data) => {
    ...
    let document = {
      documentdetail: data,
      documentname: "Routine Scan And Examination",
    ...
    try {
      if (!!draftDoc && draftDoc.status === "Draft") {
        ...
        toast.success("Routine scan and examination updated successfully");
      } else {
        await ARTClinicalDocumentServ.create(document);
        toast.success("Routine scan and examination created successfully");
      }
    ...
    <>
      <div className="card ">
        <Box
          ...
          mb={1}
        >
          <FormsHeaderText text={"Routine scan and examination"} />
