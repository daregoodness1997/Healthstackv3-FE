...
export default function CounsellorNoteCreate() {
    ...
    const onSubmit = async (data) => {
        ...
        try {
          if (!!draftDoc && draftDoc.status === "Draft") {
            ...
            toast.success("Counsellor Note updated successfully");
          } else {
            await ARTClinicalDocumentServ.create(document);
            toast.success("Counsellor Note created successfully");
          }
          
          closeEncounterRight()
        } catch (err) {
          toast.error("Error submitting Counsellor Note: " + err);
      ...
      <>
        <div className="card ">
          ...
          <Box
            ...
            mb={1}
          >
            <FormsHeaderText text={"Counsellor Note"} />
