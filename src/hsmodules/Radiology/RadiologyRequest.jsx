...
export default function RadiologyRequest() {
  ...
  return (
    <section className="section remPadTop">
      <RadiologyRequestList openModal={openModal} setOpenModal={setOpenModal} />
    </section>
  );
}

export function RadiologyRequestList() {
  ...
  const handleDelete = () => {
    showActionLoader();
    BillServ.remove(reqToDelete._id)
      .then(() => {
        hideActionLoader();
    ...
    <>
      <PageWrapper style={{ flexDirection: 'column', padding: '0.6rem 1rem' }}>
        ...
        <CustomConfirmationDialog
          ...
          type="danger"
          message={`You are about to delete a radiology request for: ${reqToDelete?.orderInfo.orderObj.clientname
            } made by ${reqToDelete?.orderInfo.orderObj.requestingdoctor_Name}?`}
        />
