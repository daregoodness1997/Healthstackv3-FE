...
import OrganizationListRefactored from './refactored/OrganizationListRefactored';
import { useOrganizationStore } from '../../stores/organizationStore';

export default function Facility() {
  const { state } = useContext(ObjectContext);
  const { selectedOrganization, showModal, setShowModal, clearSelection } =
  ...
  return (
    <div style={{ padding: '24px' }}>
      ...
      <Modal
        ...
        destroyOnClose
      >
        <FacilityCreate closeModal={() => setCreateModal(false)} />
      </Modal>
...
export function FacilityModify() {
  ...
  const handleDelete = async () => {
    ...
    try {
      await facilityServ.remove(facility._id);
