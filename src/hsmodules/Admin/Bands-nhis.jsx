      ...
      switch (avail.total) {
        case 0:
          ...
          let facilitydata = {
            ...
            facilityAddress:
              benfi.CustomerAddress1 +
              " " +
              benfi.CustomerAddress2 +
              " " +
              benfi.CustomerAddress3,
 ...
 */
    ...
    dependents.push(newclient)
      ...
      let policy = {
        ...
        //find sponsor
        sponsor: { facilityName: facit.sponsor, code: facit.sponsorID },
        ...
        //  validityPeriods:[ { type: String,  }],
        validitystarts:
          facit.validitystarts !== "NULL" ? facit.validitystarts : new Date(),
        validityEnds:
          facit.validityEnds !== "NULL" ? facit.validityEnds : new Date(),
        Date_JoinScheme:
          facit.Date_JoinScheme !== "NULL" ? facit.Date_JoinScheme : new Date(),
        active: true,
        isPaid: true,
        approved: true,
        status: "Approved",
