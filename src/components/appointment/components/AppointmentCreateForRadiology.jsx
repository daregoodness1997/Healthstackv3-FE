...
const AppointmentCreateForRadiology = ({ closeModal, showBillModal }) => {
    ...
    return (
        ...
        >
          ...
          />
                ...
                <Grid item xs={12} sm={12} md={12} lg={12}>
                    <Textarea
                        label="Radiology Procedure(s)"
                        name="appointment_reason"
                        //important
                        register={register('appointment_reason')}
                        type="text"
                        placeholder="Procedure to be done.."
                    />
                </Grid>
...
export default AppointmentCreateForRadiology
